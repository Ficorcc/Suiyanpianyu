      ...
      config.optimization = {
        ...
        splitChunks: {
          ...
          cacheGroups: {
            ...
            waline: {
              name: 'waline',
              test: /[\\/]node_modules[\\/](@waline|vue|@vueuse|marked|autosize)[\\/]/,
              chunks: 'all',
              priority: 20,
              reuseExistingChunk: true,
              enforce: true,
